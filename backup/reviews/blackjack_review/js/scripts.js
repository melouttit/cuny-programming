$(document).ready(function(){
	...
	var deck = [		
		...
		new card('Ace','Diamonds',11), //diamonds
	...
	var used_cards = new Array(); //used cards array
	...
	var hand = {
		...
		sumCardTotal: function(){
			...
			} else if(this.current_total <= 21 && this.cards.lenght == 5){
				$("#btnStick").trigger("click");
				$("#imgResult").attr('src','images/check.png');
			...
			$("#hrdTotal").html("Total: "+this.current_total);
