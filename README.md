...
<ul>
  ...
  <li><strong>9 Plugins & Workshop:</strong> This week we will go over how jQuery plugins work and how they can quickly be added to a website to enhance interactivity. Students will find a plugin they want to add to their site and we will spend workshop time configuring them to each students’ website. The last part of the workshop we will use our new <strong>git</strong> knowledge to create a different branch of our project to practice with plugins on.</li>
